    ...
    <section class="about-us">
        ...
        <div class="banner">
            ...
            <div class="banner-content">
                <h2 class="title">viện thành viên hội đồng quản trị việt nam (viod)</h2>
            </div>
        </div>
    </section>
                        ...
                        <div class="description">
                            <div class="text-content text-content-about-us"" id=" textContent">
                                <p>Viện Thành viên Hội đồng Quản trị Việt Nam (VIOD) là định chế chuyên nghiệp, độc lập và tiên phong về Quản trị Công ty (QTCT) và Phát triển bền vững tại Việt Nam.
                                    ...
                                    <br class="d-none d-md-block">
                                    VIOD có sứ mệnh thúc đẩy nâng cao chất lượng và mặt bằng QTCT thông qua đào tạo, huấn luyện và đánh giá thực hành QTCT theo luật định, các chuẩn mực và thông lệ quốc tế.
                                    <br class="d-none d-md-block">
                                    <br class="d-none d-md-block">
                                    Các hoạt động của VIOD hướng đến chuyên nghiệp hóa Hội đồng Quản trị (HĐQT), hỗ trợ thúc đẩy các chuẩn mực cao về tính minh bạch và đạo đức kinh doanh. VIOD đồng thời xây dựng và phát triển mạng lưới những người thực hành và làm Nghề QTCT, đó là các thành viên HĐQT, các thành viên phụ trách & thư ký QTCT, các nhà tư vấn đến từ các công ty tư vấn trong hệ sinh thái QTCT của thị trường.
                                </p>
                            </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="overview-box h-100">
                            ...
                            <p class="box-content">
                                Các tổ chức, cá nhân mong muốn xây dựng và áp dụng thông lệ tốt về QTCT hướng đến Phát triển bền vững. Từ thành viên HĐQT, Giám đốc điều hành đến các cơ quan quản lý và tổ chức học thuật, chuyên môn về QTCT.
                            </p>
                        </div>
                    </div>
