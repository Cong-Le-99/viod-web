<section class="contact-us-global-partnerships session-wrap relative">
    <div class="contact-us-container-custom">
        ...
        <div class="row gy-2 md-gy-4">
            <!-- Cột A: 6 logo đối tác -->
            <div class="col-12 col-md-6">
                <div class="partnerships-item d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="row w-100 g-2 global-partnerships-wrap">
                        ...
                        <div class="col-6 col-md-4"><img class="w-100 h-auto" src="<?php echo get_template_directory_uri(); ?>/images/partnership-4.png" alt="partnership-4"></div>
                        <div class="col-6 col-md-4"><img class="w-100 h-auto" src="<?php echo get_template_directory_uri(); ?>/images/partnership-5.png" alt="partnership-5"></div>
                        <div class="col-6 col-md-4"><img class="w-100 h-auto" src="<?php echo get_template_directory_uri(); ?>/images/partnership-6.png" alt="partnership-6"></div>
                    </div>
                </div>
            </div>
            <!-- Cột B: 1 hình, box ACGN, content -->
            <div class="col-12 col-md-6">
                <div class="partnerships-item d-flex flex-column align-items-center justify-content-center">
                    <div class="partnerships-item-title mb-3">
                        <h3>Thành viên các mạng lưới</h3>
                    </div>
                    <div class="mb-3 w-100 d-flex justify-content-center">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/parnership-0.png" alt="parnership-0" class="img-fluid" style="max-width:220px;">
                    </div>
                    ...
                    <div class="partnerships-item-content mb-3 mt-3 d-block d-md-none">
                        <p class="viod-member-content text-center mb-0">VIOD là thành viên của Mạng lưới ASEAN về Quản trị Khí hậu</p>
                    </div>
                </div>
            </div>
        </div>
