...
$child_category = get_category_by_slug('tai-lieu-ve-qtct-cua-viet-nam');
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-6 ">
                ...
                <button class="btn-register mt-5" onclick="window.location.href='/van-ban-phap-luat-lien-quan/?category=tai-lieu-ve-qtct-cua-viet-nam'">
                Xem tất cả
                </button>
            </div>
