...
$categories = get_categories([
    'parent' => 0, // Chỉ lấy parent categories (không có parent)
    'hide_empty' => false,
    'number' => 4
]);

// Nếu không có categories, tạo mảng mặc định
if (empty($categories)) {
    $categories = [
        (object) ['term_id' => 0, 'name' => 'Tài liệu về QTCT', 'slug' => 'tai-lieu-ve-qtct-cua-viet-nam'],
    ];
}

// Lấy bài viết cho tất cả categories (tối đa 4 bài viết mỗi category)
$category_posts = [];
foreach ($categories as $category) {
    $posts_query = new WP_Query([
        'post_type' => 'post',
        'posts_per_page' => 4, // Lấy tối đa 4 bài viết
...
// Lấy bài viết mặc định (category đầu tiên)
