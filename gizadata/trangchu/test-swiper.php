<?php
/**
 * Test file để kiểm tra Swiper
 */
?>

<section class="training-program relative overflow-hidden">
    <div class="container">
        <h2 class="title">TEST SWIPER</h2>
        <p class="description mb-4">Test file để kiểm tra Swiper hoạt động</p>
    </div>

    <!-- Swiper Container -->
    <div class="upcoming-training-programs-swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="ct1 relative card-event">
                    <div class="card-event_img">
                        <img src="https://viod.1994.cloud/wp-content/uploads/2025/05/image_image_szoz.webp" alt="Test 1">
                    </div>
                        ...
                        <div class="card-event_wrapper">
                            ...
                            <div class="card-event_button">
                                <div class="button-group">
                                    <a href="/chuong-trinh-dao-tao/" class="btn-register">
            ...
            <div class="swiper-slide">
                <div class="ct2 relative card-event">
                    <div class="card-event_img">
                        <img src="https://viod.1994.cloud/wp-content/uploads/2025/05/image_image-1_n2UQ.webp" alt="Test 2">
                    </div>
                    <div class="card-event_content">
                        <div class="card-event_wrapper">
                            <div class="card-event_tag">
...
<script>
// Đợi cho cả DOM và Swiper library load xong
function initTestSwiper() {
    ...
    const swiperContainer = document.querySelector('.upcoming-training-programs-swiper');
    if (!swiperContainer) {
        console.error('Không tìm thấy container .upcoming-training-programs-swiper');
        return;
    }
    
    // Kiểm tra xem có slides không
    const slides = swiperContainer.querySelectorAll('.swiper-slide');
    if (slides.length === 0) {
        console.error('Không có slides nào trong container');
        return;
    }
    
    console.log('Test: Tìm thấy', slides.length, 'slides');
    
    // Kiểm tra xem Swiper đã được khởi tạo chưa
    if (swiperContainer.swiper) {
        console.log('Test: Swiper đã được khởi tạo trước đó');
        return;
    }
    
    // Khởi tạo Swiper cho test
    const testSwiper = new Swiper('.upcoming-training-programs-swiper', {
        slidesPerView: 1,
        spaceBetween: 0,
        grabCursor: true,
        ...
        // Navigation arrows
        navigation: {
            nextEl: '.upcoming-training-programs-swiper .swiper-button-next',
            prevEl: '.upcoming-training-programs-swiper .swiper-button-prev',
        },
        ...
        on: {
            init: function() {
                console.log('Test: Swiper đã được khởi tạo thành công');
            },
            slideChange: function() {
                console.log('Test: Slide changed to:', this.activeIndex);
            }
        }
    });
    
    console.log('Test: Swiper instance:', testSwiper);
}

// Thử khởi tạo ngay khi DOM ready
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(initTestSwiper, 100);
});

// Thử khởi tạo khi window load
window.addEventListener('load', function() {
    setTimeout(initTestSwiper, 200);
});
</script> 